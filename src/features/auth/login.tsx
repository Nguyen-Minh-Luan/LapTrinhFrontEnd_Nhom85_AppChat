...
import { CURRENT_SOCKET, EV_GET_USER_LIST } from "../../module/appsocket";
...
const Login = () => {
  ...
  CURRENT_SOCKET.addMessageReceived("LOGIN", (id, data) => {
    ...
    if (data.event === EV_GET_USER_LIST && id === "LOGIN") {
      ...
      if (newestItem.type === 0) navigate(`/home?user=${newestItem["name"]}`);
      if (newestItem.type === 1) navigate(`/home?roomid=${newestItem["name"]}`);
    }
  });
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      CURRENT_SOCKET.removeMessageReceived("LOGIN");
    };
  }, []);
    ...
    <div className="login-wrapper">
      <div className="login-container">
        ...
        <form onSubmit={handleSubmit} className="login-form">
          ...
          {state.error && (
            <p className="changeInfo">Sai username và password.</p>
          )}
